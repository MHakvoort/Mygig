<div class="container">
    <div class="card card-container">
        ...
        <form class="form-signin">
            ...
            <input type="email" id="inputEmail" class="form-control" placeholder="Emailadres" required>
            <input type="password" id="inputPassword" class="form-control" placeholder="Wachtwoord" required>

            <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Registreren</button>
        </form><!-- /form -->
    </div><!-- /card-container -->
</div><!-- /container -->